...
export default function MusyrifPage() {
  ...
  const data: Musyrif[] = [
    { id: 1, nama: "Musyrif 1", nim: "00000000001", usroh: "KBK" },
    { id: 2, nama: "Musyrif 2", nim: "00000000002", usroh: "MAQ" },
    { id: 3, nama: "Musyrif 3", nim: "00000000003", usroh: "JAB" },
    { id: 4, nama: "Musyrif 4", nim: "00000000004", usroh: "ZBK" },
    { id: 5, nama: "Musyrif 5", nim: "00000000005", usroh: "SBH" },
    { id: 6, nama: "Musyrif 6", nim: "00000000006", usroh: "KBK" },
    { id: 7, nama: "Musyrif 7", nim: "00000000007", usroh: "KBK" },
    { id: 8, nama: "Musyrif 8", nim: "00000000008", usroh: "KBK" },
    { id: 9, nama: "Musyrif 9", nim: "00000000009", usroh: "KBK" },
    { id: 10, nama: "Musyrif 10", nim: "00000000010", usroh: "KBK" },
  ];
                  ...
                  <tr key={item.id} className="text-center">
                    ...
                    <td className="border py-3">
                      <div className="flex justify-center gap-4">
                        <a
                          href={`/admin/musyrif/${item.id}`}
                          className="text-green-700 hover:scale-110 transition"
                        >
                          👁
                        </a>
                        <a
                          href={`/admin/musyrif/edit/${item.id}`}
